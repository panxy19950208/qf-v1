        ...
        <div class="clearfixLeft" id="clearcontent">
            ...
            <div class="box">
                ...
                <div class="tb-booth tb-pic tb-s310">
                    <a href="${product.image}"><img src="${product.image}" alt="细节展示放大镜特效" rel="${product.image}" class="jqzoom" /></a>
                </div>
                <ul class="tb-thumb" id="thumblist">
                    <li class="tb-selected">
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="${product.image}" mid="${product.image}" big="${product.image}"></a>
                        </div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40">
